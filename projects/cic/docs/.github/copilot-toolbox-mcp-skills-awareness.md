...
_Generated: 2026-05-15T22:09:25.101Z_
...
Workspace `mcp.json` _(folder: docs)_

- **c:\Users\soren\cic\docs\.vscode\mcp.json** — _File missing_

_No active workspace servers in mcp.json._

## MCP — user profile

- **C:\Users\soren\AppData\Roaming\Code\User\mcp.json** — _File missing_
